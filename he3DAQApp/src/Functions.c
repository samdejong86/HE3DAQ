...
/* -------------------------------------------------------------------------------------------- */ 
  int
DataConsistencyCheck (uint32_t * buff32, int NumWords) 
{
  int i, zcnt = 0, pnt = 0;
  uint32_t EventSize;
...
/* -------------------------------------------------------------------------------------------- */ 
  int
SaveHistogram (char *basename, int b, int ch, uint32_t * EHisto) 
{
...
/* -------------------------------------------------------------------------------------------- */ 
  int
SaveWaveform (int b, int ch, int trace, int size, int16_t * WaveData) 
{
  /*
    This function saves the waveform in a textfile as a sequence of number representing the 
    wave height
  */ 
  FILE * fh;
  int i;
...
/* -------------------------------------------------------------------------------------------- */ 
  int
SaveDigitalProbe (int b, int ch, int trace, int size, uint8_t * WaveData) 
{
  /*
    This function saves the digital waveform in a textfile as a sequence of number representing 
    the wave height
  */ 
  FILE * fh;
  int i;
