...
/* Generated from ../O.Common/he3DAQ.dbd */
...
epicsShareExtern void (*pvar_func_register_func_commandRoutine)(void);
epicsShareExtern void (*pvar_func_register_func_paramRoutine1)(void);
epicsShareExtern void (*pvar_func_register_func_paramRoutine2)(void);
epicsShareExtern void (*pvar_func_register_func_histoRoutine)(void);
...
{
    const char *bldTop = "/root/epics/he3daq";
    ...
    (*pvar_func_asSub)();
    (*pvar_func_register_func_commandRoutine)();
    (*pvar_func_register_func_paramRoutine1)();
    (*pvar_func_register_func_paramRoutine2)();
    (*pvar_func_register_func_histoRoutine)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"he3DAQ_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    he3DAQ_registerRecordDeviceDriver(*iocshPpdbbase);
}
